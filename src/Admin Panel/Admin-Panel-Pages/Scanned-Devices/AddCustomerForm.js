	...
	return (
	  <>
		  ...
		  <form>
				...
				return (
				  <div key={index}>
					<div className="row">
					 ...
					 <h6> <i class="fa-solid fa-child me-2"></i>	Position</h6>
						<input
						  name="position"
						  className="input"
					  ...
					  <div className="col-md-6  pt-3 ">
						<h6> <i class="fa-regular fa-clock me-2"></i>Time Of Exposure <i className="lead small">(In Minutes)</i></h6>
						<input
						  name="scan_time"
						  className="input"
			...
			className="btn mt-2 btn-success ms-4"
