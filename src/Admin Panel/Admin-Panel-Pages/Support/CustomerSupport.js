        ...
        <div className="row w-100 mx-0">
		  ...
		  <div className="col-lg-8 mt-5">
            <div className="auth-form-light  loginForm text-left py-5 px-4 px-sm-5">
              ...
              <div>
                <div class="card mt-4">
                  <div class="card-header"> <i class="fa-solid fa-comment me-2"></i> Chat</div>
                          ...
                          >
                            ...
                            <div class="chat-body">
                              <div class="chat-message">
                                <h5 style={{color:item.sentFrom === "admin" ? "Blue" : "#571212"}}>
                                  {item.sentFrom === "admin" ? "Admin" : "You"}
                                </h5>
		  ...
		  <div className="col-lg-4 mt-5">
			...
			<div className="auth-form-light  loginForm text-left py-5 px-4 px-sm-5">
              ...
              <div>
                <div class="card mt-4">
                  <div class="card-header">   <i className="fa-solid fa-message text-light me-2"></i> Message</div>
				  <Form className="pt-3">
